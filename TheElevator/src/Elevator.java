...
public class Elevator extends JPanel implements ActionListener
{
  ...
  public void setFloor(int f) {
  	...
  	// Problem 4:
  	doorOpen = buttons[1] && !floorBits[0] || buttons[0] && !floorBits[1] || buttons[2] && floorBits[0] && floorBits[1];
  	...
  	// Problem 6:
  	lightUp =  (!floorBits[0] && floorBits[1]) || (floorBits[0] && !floorBits[1] && !buttons[0]);
  	lightDown = (floorBits[0]) && (!floorBits[0] || floorBits[1] || buttons[0] || !buttons[2]);
